...
### Data
matches <- read_tsv("//Users/toonscheurink/NoniCloud/Aging MASST results/microbe_masst/output/data/Batch_MASST_matches.txt")
ReDu <-fread("/Users/toonscheurink/NoniCloud/Aging MASST results/all_sampleinformation.tsv")
metab <- readRDS("ranked_metabolites.rds")
metab <-rename(metab, Scan = Metabolite)
metabanno  <- fread("annotated_molecules_edit.csv")
datasets <- read_tsv("//Users/toonscheurink/NoniCloud/Aging MASST results/microbe_masst/output/data/Batch_MASST_datasets.txt")
...
heatmap_disease
#ggsave("heatmap_disease.svg", plot = heatmap_disease, dpi =300, width = 12, height = 8)
...
#ggsave("Disease_plot_clean_combined.svg", plot = combined_plot, dpi =300, width = 16, height = 8)
...
#ggsave("clean_plot_body.svg", plot = combined_plot_body_2, dpi =300, width = 15, height = 8)
